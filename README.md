...
### 3. Run the Notebooks
Once activated, the environment is ready to run the notebooks.

> **Note:** Development and execution are done using **VS Code** with Jupyter notebook support.
...
| `football` | Analysis of football matches | Jul 1, 2026 ||
